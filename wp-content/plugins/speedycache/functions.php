...
function speedycache_page_header(){
	...
	echo '<div class="speedycache-admin-header" style="background-color:#131243; color: white; padding:15px 10px; margin:0 0 10px -20px;">
	<div class="speedycache-brand-title" style="display:flex; align-items:center; font-size:20px; font-weight:500; margin-left:20px;"><img src="'.esc_attr(SPEEDYCACHE_URL) .'/assets/images/icon.svg" width="30px" height="30px"/><span style="margin-left:7px;">'.esc_html($title).'</span><span style="color:rgba(255,255,255,0.5); margin-left:3px; font-weight:400; font-size:0.9rem; line-height:2;"> - v'.esc_html(SPEEDYCACHE_VERSION).'</span></div>';
