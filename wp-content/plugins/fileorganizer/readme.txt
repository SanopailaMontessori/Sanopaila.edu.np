...
* [Feature] Added some setting to configure FileOrganizer file manager.
...
* [Pro-Feature] Added options to restrict feature and set limited access to FileOrganizer by users and user roles.
